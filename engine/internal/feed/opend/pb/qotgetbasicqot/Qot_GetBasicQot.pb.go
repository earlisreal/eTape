...
const file_Qot_GetBasicQot_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x14.Qot_GetBasicQot.S2CR\x03s2cB_\n" +
	"\x13com.futu.openapi.pbZHgithub.com/earlisreal/eTape/engine/internal/feed/opend/pb/qotgetbasicqot"
