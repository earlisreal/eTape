...
const file_Qot_RequestTradeDate_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x19.Qot_RequestTradeDate.S2CR\x03s2cBd\n" +
	"\x13com.futu.openapi.pbZMgithub.com/earlisreal/eTape/engine/internal/feed/opend/pb/qotrequesttradedate"
