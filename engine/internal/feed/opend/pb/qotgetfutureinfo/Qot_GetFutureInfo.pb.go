...
const file_Qot_GetFutureInfo_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x16.Qot_GetFutureInfo.S2CR\x03s2cBa\n" +
	"\x13com.futu.openapi.pbZJgithub.com/earlisreal/eTape/engine/internal/feed/opend/pb/qotgetfutureinfo"
