...
const file_Trd_GetPositionList_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x18.Trd_GetPositionList.S2CR\x03s2cBc\n" +
	"\x13com.futu.openapi.pbZLgithub.com/earlisreal/eTape/engine/internal/feed/opend/pb/trdgetpositionlist"
