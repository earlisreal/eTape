...
const file_Qot_GetHistoryKL_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x15.Qot_GetHistoryKL.S2CR\x03s2cB`\n" +
	"\x13com.futu.openapi.pbZIgithub.com/earlisreal/eTape/engine/internal/feed/opend/pb/qotgethistorykl"
