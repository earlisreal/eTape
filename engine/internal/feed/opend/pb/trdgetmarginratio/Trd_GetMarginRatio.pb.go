...
const file_Trd_GetMarginRatio_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x17.Trd_GetMarginRatio.S2CR\x03s2cBb\n" +
	"\x13com.futu.openapi.pbZKgithub.com/earlisreal/eTape/engine/internal/feed/opend/pb/trdgetmarginratio"
