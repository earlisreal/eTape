...
const file_Qot_OptionScreen_proto_rawDesc = "" +
	...
	"%OptionIndicatorType_BuyBreakEvenPoint\x10\xcf\x17\x1a\x02\b\x01B`\n" +
	"\x13com.futu.openapi.pbZIgithub.com/earlisreal/eTape/engine/internal/feed/opend/pb/qotoptionscreen"
