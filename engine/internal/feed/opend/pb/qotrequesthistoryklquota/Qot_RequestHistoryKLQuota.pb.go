...
const file_Qot_RequestHistoryKLQuota_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x1e.Qot_RequestHistoryKLQuota.S2CR\x03s2cBi\n" +
	"\x13com.futu.openapi.pbZRgithub.com/earlisreal/eTape/engine/internal/feed/opend/pb/qotrequesthistoryklquota"
