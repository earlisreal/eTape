...
func testFrontmatterParityEnums(t *testing.T) {
	...
	enums := map[string][]string{
		...
		"TickTradeReportCondition": {
			string(wsmsg.TradeConditionUnknown), string(wsmsg.TradeConditionAutomaticMatch), string(wsmsg.TradeConditionLate),
			string(wsmsg.TradeConditionNonAutomaticMatch), string(wsmsg.TradeConditionSameBrokerAutomaticMatch), string(wsmsg.TradeConditionSameBrokerNonAutomaticMatch),
			string(wsmsg.TradeConditionOddLot), string(wsmsg.TradeConditionAuction), string(wsmsg.TradeConditionBunchedTrade), string(wsmsg.TradeConditionCashSale),
			string(wsmsg.TradeConditionIntermarketSweep), string(wsmsg.TradeConditionBunchedSold), string(wsmsg.TradeConditionPriceVariation), string(wsmsg.TradeConditionRule127Or155),
			string(wsmsg.TradeConditionDelayed), string(wsmsg.TradeConditionMarketCenterOfficialClose), string(wsmsg.TradeConditionNextDaySettlement), string(wsmsg.TradeConditionMarketCenterOpening),
			string(wsmsg.TradeConditionPriorReferencePrice), string(wsmsg.TradeConditionMarketCenterOfficialOpen), string(wsmsg.TradeConditionSeller), string(wsmsg.TradeConditionFormT),
			string(wsmsg.TradeConditionExtendedHours), string(wsmsg.TradeConditionContingent), string(wsmsg.TradeConditionAveragePrice), string(wsmsg.TradeConditionOTCSold),
			string(wsmsg.TradeConditionOddLotIntermarketSweep), string(wsmsg.TradeConditionDerivativelyPriced), string(wsmsg.TradeConditionReopeningPrice), string(wsmsg.TradeConditionClosingPrice),
			string(wsmsg.TradeConditionCorrectedComprehensiveLate), string(wsmsg.TradeConditionOverseas),
		},
		"TickDeliverySource": {string(wsmsg.DeliveryUnknown), string(wsmsg.DeliveryRealtime), string(wsmsg.DeliveryDisconnectBackfill), string(wsmsg.DeliveryCache)},
