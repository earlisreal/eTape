...
export const TV_LIGHT: Palette = {
  ...
  buyFill: "rgba(165,214,167,.8)",
  sellFill: "rgba(244,143,177,.8)",
  shortFill: "rgba(33,150,243,.8)",
  fillOutline: "#131722",
  neutral: "#787B86",
  ...
  flashBuyStrong: "rgba(8,153,129,.50)",
  flashSellStrong: "rgba(242,54,69,.50)",
  flashNeutralStrong: "rgba(120,123,134,.36)",
  orderMark: "#2962FF",
...
export const TV_DARK: Palette = {
  ...
  flashBuyStrong: "rgba(8,153,129,.56)",
  flashSellStrong: "rgba(242,54,69,.56)",
  flashNeutralStrong: "rgba(240,243,250,.30)",
  orderMark: "#2962FF",
