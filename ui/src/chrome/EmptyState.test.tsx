...
describe("EmptyState", () => {
  ...
  it("shows the 'Try demo' CTA when showTryDemo is true", () => {
    render(<AppProviders><EmptyState onAddPanel={() => {}} onApplyPreset={() => {}} onOpenMonitoring={() => {}} showTryDemo={true} onTryDemo={() => {}} onImportLayoutFile={() => {}} /></AppProviders>);
  ...
  it("clicking 'Try demo' calls onTryDemo, not onAddPanel/onApplyPreset", () => {
    ...
    render(<AppProviders><EmptyState onAddPanel={onAddPanel} onApplyPreset={onApplyPreset} onOpenMonitoring={() => {}} showTryDemo={true} onTryDemo={onTryDemo} onImportLayoutFile={() => {}} /></AppProviders>);
  ...
  it("renders the 'Import layout' control regardless of showTryDemo, and forwards the picked file", () => {
    ...
    render(<AppProviders>
      <EmptyState onAddPanel={() => {}} onApplyPreset={() => {}} onOpenMonitoring={() => {}} showTryDemo={false} onTryDemo={() => {}} onImportLayoutFile={onImportLayoutFile} />
    </AppProviders>);
