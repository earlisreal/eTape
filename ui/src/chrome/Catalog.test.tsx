...
describe("Catalog", () => {
  it("lists Monitoring, presets, and the non-dev panel index", () => {
    ...
    render(<ThemeProvider><Catalog onAddPanel={() => {}} onApplyPreset={() => {}} onOpenMonitoring={() => {}} /></ThemeProvider>);
  ...
  it("adds a panel on click and applies a preset on click", () => {
    ...
    render(<ThemeProvider><Catalog onAddPanel={onAddPanel} onApplyPreset={onApplyPreset} onOpenMonitoring={onOpenMonitoring} /></ThemeProvider>);
