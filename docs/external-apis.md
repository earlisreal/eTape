...
- OpenD rank responses 3410/3413/3411/3412 remain Scanner discovery sources for price, change, and an initial matching-session volume. Snapshot 3203 supplies the base daily volume/dollar turnover and matching-session volume used for rows and filters; phase/pool-day provenance prevents stale session fallback. The UI thresholds remain raw shares/USD and saved values are additive.
